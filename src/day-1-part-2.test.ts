...
import day2 from "./day-1-part-2.js";

describe("2", () => {
  it("should return the correct sum for a single line document", () => {
    const document = "two1nine\neightwothree\nabcone2threexyz\nxtwone3four\n4nineeightseven2\nzoneight234\n7pqrstsixteen";
    const expectedSum = 281;
    expect(day2(document)).toEqual(expectedSum);
  });
  it('does the puzzle input', () => {
    const puzzleInput = `51591twosix4dhsxvgghxq
425nine
llvmhjtr8nbbhrfone
...
5cfprzgxtf3465five`;
    ...
    expect(day2(puzzleInput)).toEqual(55413);
  });
});
